  ...
  list: [
    {
      ...
      trait: '美丽而骄傲，内心温柔',
      chapter: '第8章',
      background: '玫瑰是《小王子》中最重要的角色之一。她美丽而骄傲，有时任性，但小王子依然深爱着她。通过玫瑰，故事告诉我们：爱需要付出和耐心。'
    },
    {
      id: 'king',
      name: '国王',
      ...
      trait: '追求权威但讲道理',
      chapter: '第10章',
      background: '国王统治着一个空荡荡的星球，却认为自己统治着一切。他教会我们：真正的权威不是控制别人，而是懂得什么是合理的。'
    },
    {
      id: 'vain',
      name: '爱慕虚荣的人',
      ...
      trait: '渴望被赞美和认可',
      chapter: '第11章',
      background: '爱慕虚荣的人只想听到赞美，他的星球上只有他一个人。他提醒我们：过度追求他人认可，会让人迷失自我。'
    },
    {
      id: 'merchant',
      name: '商人',
      ...
      trait: '忙碌而认真，很会算术',
      chapter: '第13章',
      background: '商人整天忙着数星星，认为拥有它们就是价值。他让我们思考：忙碌本身是否有意义？我们是否忽略了更重要的东西？'
    }
  ],
